...
public class gRCenforceApprove_Remediation_Task extends generalUtils {
...
@Test(priority=3)
	...
	String sp3= array[0]+"_"+sp2;
		...
		driver.findElement(By.xpath("//*[text()='"+sp3+"']/ancestor::div[@ng-style='Viewport.rowStyle(rowRenderIndex)']//input[contains(@ng-checked,'Approve')]")).click();
